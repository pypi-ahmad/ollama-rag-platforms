"""Environment-driven settings for the multi-agent project."""
...
class Settings(BaseSettings):
    ...
    planner_model: str = "phi3.5:3.8b"
    reviewer_model: str = "functiongemma:270m"
    ...
    generation_timeout_seconds: float = Field(default=8.0, ge=1.0, le=60.0)
    ...
    def report_file(self) -> Path:
        return self.resolved_report_dir / "multi_agent_system_report.md"
    ...
    def demo_runs_file(self) -> Path:
        return self.resolved_runs_dir / "demo_runs.json"
