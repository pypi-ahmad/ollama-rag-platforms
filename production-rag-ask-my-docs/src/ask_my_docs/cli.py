...
app = typer.Typer(help="Production RAG with observability and regression gates")
...
def ask(
    ...
    top_k: Annotated[
        int | None,
        typer.Option(help="Number of retrieved chunks"),
    ] = None,
    output: Annotated[
        Path | None,
...
def metrics_summary(
    limit: Annotated[int | None, typer.Option(help="Optional row limit")] = None,
) -> None:
    """Print aggregate observability metrics from DuckDB."""

    _, metrics_store = _build_pipeline()
